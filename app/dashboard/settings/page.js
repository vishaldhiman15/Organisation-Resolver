...
export default function SettingsPage() {
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div>
        <h2 style={{ margin: 0, fontSize: '1.75rem' }}>⚙️ Organization Settings</h2>
        <p style={{ color: 'var(--text-secondary)', marginTop: '0.5rem' }}>Configure strict attendance boundaries.</p>
      </div>
